(function() {
  ...
  function lotToManufacture(event) {
      ...
      // 「UFBロットNo参照用」を取得し、「製造番号」(dtm)にする
      var dt = record['UFBロットNo参照用'].value;
  ...
  // 新規作成画面と編集画面で「UFBロットNo参照用.」を取得したときに動作する
  kintone.events.on(['app.record.create.change.UFBロットNo参照用', 'app.record.edit.change.UFBロットNo参照用'], lotToManufacture);
